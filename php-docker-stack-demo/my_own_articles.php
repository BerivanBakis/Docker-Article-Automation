...
FROM article_table
JOIN user_table ON article_table.user_id = user_table.id WHERE user_id = {$_SESSION['user_id']}";
            ...
            <div class="face face2">
                <div class="content">
                    ...
                    <div style="display: flex; flex-direction: row; justify-content: center;">
                        <div class="wrap">
                        <a href='my_own_articles.php?id=<?php echo $row['id'] ?>'><button class="button delete">Delete</button></a>
                            
                          </div>
                          <div class="wrap">
                          <a href='update_article.php?id=<?php echo $row['id'] ?>'><button class="button update">Update</button></a>
                          </div>
                      </div>
                </div>
            </div>
